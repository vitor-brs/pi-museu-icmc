...
addOrg.addEventListener('change', (ev) => {
    const tagValue = '<input id="otherOrg" name="outros" class="form-control mb-2" type="text" aria-label="Outro tipo de organização" placeholder="Informe o tipo da sua organização" required>'
...
dataVisita1.addEventListener('blur',(ev) => {
    validaData('')
});
