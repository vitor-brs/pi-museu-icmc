          ...
          <div class="container">
              <div class="row">
                  <div class="col-sm-7 text fonts">
                      ...
                      <div>
                          <p class="">
                              Área de acesso aos colaboradores do museu. 
                          </p>
                      </div>
                  </div>
                  <div class="col-sm-5 form-box mb-3">
                      <div class="form-top">
                          <div class="form-top-left">
                              <h3 class="">Login</h3>
                              <p class="">Entre com o usuário e senha.</p>
                          </div>
                      ...
                      <div class="form-bottom mb-3">
                          <form method="post" name="form_login">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="user" placeholder="Usuário" class="form-control" name="usuario" required>
                              </div>
...
<!-- Footer -->
    ...
    <!-- Modal Erro -->
    <div id="modal-invalid-login" class="modal fade" tabindex="-1" role="Caixa de dialogo com mensagem de usuário ou senha inválido.">
